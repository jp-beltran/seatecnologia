...
function EmployeeDetails() {
    return (  
        <div className="w-1/3  bg-white p-6 rounded-[20px] flex flex-col max-h-[460px] max-w-[460px] ">
            ...
            <img src={EmployeeImg} alt="Foto do funcionário" className="mt-5 w-[142px] h-[159px]" />
        </div>
    );
}
